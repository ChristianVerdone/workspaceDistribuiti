...
//� una factory concreta che restituir� un oggetto concreto che appartiene alla classe 
...
public class PrintServiceFactoryImpl extends UnicastRemoteObject implements PrintServiceFactory{
	...
	//Il client che invoca il metodo create ricever� un'istanza del proxy, mentre sul server viene
	//creato l'oggetto remoto
